...
result can be reproduced bit-for-bit, across machines, or as parallelism is
added. We present swarm-abm, a spatial ABM engine in Rust built
...
cores for compute-bound decisions. A debris-flow application shows this
throughput turning an infeasible study --- a powered comparison of five
metaheuristic calibrators --- into a routine one. Python bindings and a
