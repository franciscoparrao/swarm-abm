...
cost for the models where parallelism matters most. Finally, our performance
evaluation covers two grid-based models (SIR and Schelling); the graph and
continuous-space paradigms, though supported by the same API, are not
benchmarked here, so the cross-engine margins should not be assumed to transfer
unchanged to those settings.
